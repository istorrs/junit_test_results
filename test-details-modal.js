                ...
                <div>
                    ...
                    <div class="flex space-x-1 mb-2">
                        ${this.testHistory.map(t => {
                            ...
                            return `<div class="${color} h-8 flex-1 rounded flex items-center justify-center text-white text-sm" title="${new Date(t.timestamp || t.created_at).toLocaleString()} - ${t.status}">${statusIcon}</div>`;
                        }).join('')}
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ${this.testHistory.map(t => `
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <td class="px-3 py-2 text-gray-900 dark:text-white">${new Date(t.timestamp || t.created_at).toLocaleString()}</td>
                                        <td class="px-3 py-2">
